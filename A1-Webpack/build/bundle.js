(() => {
  ...
  (r.n = (e) => {
    ...
    (() => {
      ...
      const m = r.p + "3fafba073a496eacd655.png",
        h = document.createElement("img");
      (h.src = m),
        document.querySelector("#logo").append(h),
        document.querySelector("button").addEventListener("click", () => {
          let e = document.querySelector(".test").value;
          const t = document.createElement("p");
          (t.innerText = e), document.querySelector(".display").append(t);
        });
    })();
})();
